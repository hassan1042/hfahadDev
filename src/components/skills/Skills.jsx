...
const Skills = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-300 flex flex-col items-center justify-center p-8">
      <h2 className="text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-gray-800 mb-4 md:mb-6 lg:mb-12 mt-2">
        My Skills
      </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mt-2">
        {skills.map((skill, index) => (
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="flex justify-center items-center max-sm:mb-2 mb-4">
              {skill.icon}
            </div>
